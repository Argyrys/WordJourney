...
public class ProjectSetup : MonoBehaviour
{
    ...
    static void CreateGameScene()
    {
        ...
        GameObject hintBtn = CreateButton(canvas.transform, "HintButton", "HINT", new Vector2(-160, 30), new Color(1f, 0.75f, 0.2f), 130, 50, new Vector2(0.5f, 0), new Vector2(0.5f, 0));
        GameObject shuffleBtn = CreateButton(canvas.transform, "ShuffleButton", "SHUFFLE", new Vector2(160, 30), new Color(0.55f, 0.55f, 0.65f), 130, 50, new Vector2(0.5f, 0), new Vector2(0.5f, 0));
